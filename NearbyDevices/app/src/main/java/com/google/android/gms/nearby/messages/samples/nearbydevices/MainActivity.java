...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
     ...
     */
    private static final Strategy SUB_STRATEGY = new Strategy.Builder().setTtlSeconds(TTL_SECONDS_INFINITE).setDiscoveryMode(Strategy.DISCOVERY_MODE_DEFAULT).setDistanceType(Strategy.DISTANCE_TYPE_EARSHOT).build();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        schedulerBT=(Button) findViewById(R.id.schedulerBT);
        schedulerBT.setVisibility(View.VISIBLE);

        schedulerBT.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Scheduler scheduler= new Scheduler(120,MainActivity.this);
        ...
        if (permissionCheck != PackageManager.PERMISSION_GRANTED) {
            ...
            schedulerBT.setVisibility(View.GONE);
        } else {
            //mPubMessage = DeviceMessage.newNearbyMessage(manager.getDeviceId());
            schedulerBT.setVisibility(View.VISIBLE);
        }
        ...
        //mPubMessage2 = DeviceMessage.newNearbyImei(manager);
        ...
        mMessageListener = new MessageListener() {
            ...
            public void onFound(final Message message) {
                ...
                //mNearbyDevicesArrayAdapter.add("Mi IMEI: "+deviceid);
            ...
            public void onLost(final Message message) {
                ...
                //mNearbyDevicesArrayAdapter.remove(
                  //      DeviceMessage.fromNearbyMessage(message).getMessageBody());
                //mNearbyDevicesArrayAdapter.add(message.toString());
                String str = new String(message.getContent());
                Log.i(TAG,"Namespace: "+message.getNamespace()+ " Content: "+ message.getContent());
                mNearbyDevicesArrayAdapter.add(str);
    ...
    private void publish() {
        ...
        //Log.i(TAG,"IMEI: "+manager.getDeviceId());
        //Log.i(TAG,"UUID: "+getUUID((getSharedPreferences(
